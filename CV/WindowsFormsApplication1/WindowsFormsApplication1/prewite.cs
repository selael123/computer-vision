...
namespace WindowsFormsApplication1
{
    internal unsafe class prewite
    {
        ...
        internal void PrewiteOperator(ref Bitmap _imgin, ref Bitmap _imgout, int _masksize)// Prewite Operator
        {
            if (_masksize % 2 == 0)
                _masksize++;
            ...
            for (int i = maskskip; i < _imgin.Height - maskskip; i++)
            {
                ...
                for (int j = maskskip; j < _imgin.Width - maskskip; j++)
                {
                    ...
                    i_temp  = Convert.ToInt32(*(ImgPtr_In - BmpData_In.Stride +1));
                    i_temp -= Convert.ToInt32(*(ImgPtr_In + BmpData_In.Stride + 1));
                    i_temp -= Convert.ToInt32(*(ImgPtr_In - BmpData_In.Stride));
                    i_temp += Convert.ToInt32(*(ImgPtr_In + BmpData_In.Stride));
                    i_temp -= Convert.ToInt32(*(ImgPtr_In - BmpData_In.Stride - 1));
                    ...
                    w_temp = Convert.ToInt32(*(ImgPtr_In - BmpData_In.Stride - 1));
                    w_temp += Convert.ToInt32(*(ImgPtr_In - 1));
                    w_temp += Convert.ToInt32(*(ImgPtr_In + BmpData_In.Stride - 1));
                    w_temp -= Convert.ToInt32(*(ImgPtr_In - BmpData_In.Stride + 1));
                    w_temp -= Convert.ToInt32(*(ImgPtr_In));
                    w_temp -= Convert.ToInt32(*(ImgPtr_In + BmpData_In.Stride + 1));
                    w_temp = Math.Abs(w_temp);
